...
- FluxMQ is still evolving. For current status of features and limitations, see [Durable queues](/messaging/durable-queues), [Configuration reference](/reference/configuration-reference), and [Roadmap](/roadmap).
