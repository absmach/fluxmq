...
See [Queue types](/messaging/durable-queues#queue-types) for detailed explanation of how classic and stream modes differ internally (PEL tracking, cursor management, etc.).
...
- [Durable queues](/messaging/durable-queues) - Queue configuration and lifecycle
- [Publishing messages](/messaging/publishing-messages) - How to publish to queues
- [Consuming messages](/messaging/consuming-messages) - Subscription patterns
