...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description:
      "High-performance, multi-protocol message broker for IoT and event-driven architectures. MQTT 3.1.1/5.0, WebSocket, HTTP, CoAP with durable queues and clustering.",
    images: [
      {
        url: "/og-image.png",
        width: 1200,
...
const softwareApplicationJsonLd = JSON.stringify({
  ...
  description:
    "FluxMQ is a high-performance, multi-protocol message broker for IoT and event-driven architectures, supporting MQTT 3.1.1/5.0, WebSocket, HTTP and CoAP.",
  offers: {
    "@type": "Offer",
    price: "0",
    priceCurrency: "USD",
