...
const (
	...
	AuthService_AuthenticateCredential_FullMethodName = "/atom.v1.AuthService/AuthenticateCredential"
)
...
type AuthServiceClient interface {
	...
	AuthenticateCredential(ctx context.Context, in *AuthenticateCredentialRequest, opts ...grpc.CallOption) (*AuthenticateCredentialResponse, error)
}
...
func (c *authServiceClient) AuthenticateCredential(ctx context.Context, in *AuthenticateCredentialRequest, opts ...grpc.CallOption) (*AuthenticateCredentialResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(AuthenticateCredentialResponse)
	err := c.cc.Invoke(ctx, AuthService_AuthenticateCredential_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AuthServiceServer interface {
	...
	AuthenticateCredential(context.Context, *AuthenticateCredentialRequest) (*AuthenticateCredentialResponse, error)
...
func (UnimplementedAuthServiceServer) AuthenticateCredential(context.Context, *AuthenticateCredentialRequest) (*AuthenticateCredentialResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method AuthenticateCredential not implemented")
}
...
func _AuthService_AuthenticateCredential_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(AuthenticateCredentialRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServiceServer).AuthenticateCredential(ctx, req.(*AuthenticateCredentialRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func (UnimplementedCertificateServiceServer) ResolveCertificate(context.Context, *ResolveCertificateRequest) (*ResolveCertificateResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ResolveCertificate not implemented")
}
func (UnimplementedCertificateServiceServer) RevokeEntityCertificates(context.Context, *RevokeEntityCertificatesRequest) (*RevokeEntityCertificatesResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method RevokeEntityCertificates not implemented")
}
